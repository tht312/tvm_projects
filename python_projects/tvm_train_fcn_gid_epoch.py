...
#param_bytes = bytearray(open("../model/GID/fcn_epoch_99", "rb").read())
...
#from load_data import img_array, label_array
...
labels = os.listdir("../dataset/label_5classes_train")
image_dir = "../dataset/image_RGB/"
label_dir = "../dataset/label_5classes_train/"
images = images[:120]
...
for epoch in range(100):
    ...
    param_bytes = tvm.runtime.save_param_dict(module.get_params())
    with open(os.path.join("../model/GID/fcn_epoch_{}".format(epoch)), "wb") as fo:
        fo.write(param_bytes)
