...
# conv2d_bw_filter
@override_native_generic_func("conv2d_bw_filter_strategy")
def conv2d_bw_filter_strategy(attrs, inputs, out_type, target):
    """conv2d_backward_filter strategy"""
    strategy = _op.OpStrategy()
    raise RuntimeError("this operator only be supported on cuda now")
